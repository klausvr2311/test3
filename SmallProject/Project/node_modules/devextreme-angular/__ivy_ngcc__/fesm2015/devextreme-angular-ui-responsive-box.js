...
DxResponsiveBoxComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxResponsiveBoxComponent, selectors: [["dx-responsive-box"]], contentQueries: function DxResponsiveBoxComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, DxiColComponent, 0);
        ɵngcc0.ɵɵcontentQuery(dirIndex, DxiItemComponent, 0);
        ɵngcc0.ɵɵcontentQuery(dirIndex, DxiRowComponent, 0);
    } if (rf & 2) {
        let _t;
...
DxResponsiveBoxComponent = __decorate([ __param(7, Inject(PLATFORM_ID)),
...
DxResponsiveBoxModule.ɵfac = function DxResponsiveBoxModule_Factory(t) { return new (t || DxResponsiveBoxModule)(); };
DxResponsiveBoxModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: DxResponsiveBoxModule });
DxResponsiveBoxModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[
            DxiColModule,
            DxiItemModule,
            DxiLocationModule,
            DxiRowModule,
        ...
        DxiRowModule,
        DxTemplateModule] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DxResponsiveBoxComponent, [{
        type: Component,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DxResponsiveBoxModule, { declarations: function () { return [DxResponsiveBoxComponent]; }, imports: function () { return [DxiColModule,
        ...
        DxiRowModule,
        DxTemplateModule]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DxResponsiveBoxModule, [{
        type: NgModule,
        args: [{
                imports: [
                    DxiColModule,
