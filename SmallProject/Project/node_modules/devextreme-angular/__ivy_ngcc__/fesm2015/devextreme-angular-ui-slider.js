...
DxSliderComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxSliderComponent, selectors: [["dx-slider"]], hostBindings: function DxSliderComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("onBlur", function DxSliderComponent_onBlur_HostBindingHandler($event) { return ctx.touched($event); })("valueChange", function DxSliderComponent_valueChange_HostBindingHandler($event) { return ctx.change($event); });
...
DxSliderComponent = __decorate([ __param(7, Inject(PLATFORM_ID)),
...
DxSliderModule.ɵfac = function DxSliderModule_Factory(t) { return new (t || DxSliderModule)(); };
DxSliderModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: DxSliderModule });
DxSliderModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[
            DxoLabelModule,
            DxoFormatModule,
            DxoTooltipModule,
            DxIntegrationModule,
        ...
        DxoTooltipModule,
        DxTemplateModule] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DxSliderComponent, [{
        type: Component,
        args: [{
                selector: 'dx-slider',
                template: '',
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DxSliderModule, { declarations: function () { return [DxSliderComponent]; }, imports: function () { return [DxoLabelModule,
        DxoFormatModule,
        DxoTooltipModule,
        DxIntegrationModule,
        DxTemplateModule,
        BrowserTransferStateModule]; }, exports: function () { return [DxSliderComponent, DxoLabelModule,
        DxoFormatModule,
        DxoTooltipModule,
        DxTemplateModule]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DxSliderModule, [{
        type: NgModule,
        args: [{
                imports: [
                    DxoLabelModule,
